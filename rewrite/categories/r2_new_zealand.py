...
BANK = [
    ...
    Q("Central Otago's basins",
      ...
      ["Elevation: the Gibbston vines stand about a hundred metres higher, and that costs weeks of season",
       ...
       "Heavier clay soils under the Gibbston blocks, which hold cold spring water against the roots all season",
    ...
    Q("The Gimblett Gravels",
      ...
      ["The afternoon sea breeze arrives blunted by distance, and the stones bank the day's heat",
    ...
    Q("A clone and a closure",
      ...
      ["A weakness one vine has, every vine has, so a new pest or virus strikes the whole region at once",
