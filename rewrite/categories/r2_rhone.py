...
BANK = [
    ...
    Q("Cote-Rotie: the terraces above Ampuis",
      ...
      ["The flat plateau behind the top of the slope",
       "Alluvial islands and river flats lying at the foot of the terraces",
    ...
    Q("The hill of Tain",
      ...
      ["The river shifted west and left a block of the Massif on its east bank",
       ...
       "It is an uplifted spur of the Alps with the same mineralogy"], 0,
    ...
    Q("Crozes, Saint-Joseph, Cornas and Saint-Peray",
      ...
      ["Reviewing the delimitation and pushing the vineyard back onto the slopes",
    ...
    Q("Chateauneuf-du-Pape: the list and the rulebook",
      ...
      ["Each vine needs a large volume of dry soil",
       "The galets must be turned by machine between the rows",
    ...
    Q("The ground beneath Chateauneuf",
      ...
      ["A deep bed of red clay that holds water in reserve",
      ...
      "The stones are the part you can see, and they do cut evaporation and hold the day's heat, but the reservoir is the red clay underneath them, holding water within reach of the roots. It is why a vine there can finish a summer that would stop a vine on light ground, and much of why the plateau gives the fullest wines of the appellation."),
    ...
    Q("From Cotes du Rhone up to cru",
      ...
      ["A delimited area covering several communes rather than one village",
       "A brand registered by growers who share a cooperative cellar",
    ...
    Q("The right bank and the sweet wines",
      ...
      ["Between five and ten percent of the must", "Between one and two percent",
       ...
       "Enough to reach twenty percent alcohol"], 0,
