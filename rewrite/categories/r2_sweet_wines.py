...
BANK = [
    ...
    Q("Sweetness as label law",
      ...
      ["Acidity high enough to come within two grams of the sugar",
       "A vintage declared hot enough for a broader band by the authorities",
       "Bottling completed before the current regulation took effect",
       "Alcohol above thirteen percent, which reads dry on the palate"], 0,
    ...
    Q("Drying lofts and arrested ferments",
      ...
      ["Control: the fruit is picked at its best, and the autumn weather can no longer touch it",
      ...
      "Drying off the vine separates two decisions the vineyard otherwise welds together: when the fruit is ripe and how long it concentrates. The price is labour and space, plus a winter spent walking the racks pulling out anything that spoils, because one mouldy bunch shares its taint with its neighbours."),
    Q("Drying lofts and arrested ferments",
