...
BANK = [
    ...
    Q("Who writes the list",
      ...
      ["An independent inspection body, on an approved control plan",
      ...
      "The work is done by an independent inspection or certification body, against a control plan the national institute has approved. Separating the people who write the rules from the people who verify compliance is the whole point of the reform, on the plain ground that no body can audit itself. Checks are also risk-based rather than universal, so an estate with a clean record is sampled less often than one that has been in trouble."),
    ...
    Q("What a rank guarantees, and what it does not",
      ...
      ["It never entered, because a classification ranks the estates that applied to it",
       ...
       "Estates above a certain size are excluded by rule, a ranking being meant to reward small holdings"], 0,
    ...
    Q("What a rank guarantees, and what it does not",
      ...
      ["Neither, each was awarded by a different body's criteria",
    ...
    Q("Ageing terms as an instrument",
      ...
      ["A fixed calendar date following the harvest",
    ...
    Q("Reserva, Riserva and Reserve across borders",
      ...
      ["The Spanish word carries minimum times in cask and in bottle, and the American one carries no requirement at all",
       ...
       "Neither carries any requirement, both being marketing words a producer may print at will"], 0,
    ...
    Q("Drawing the line, and recording the ground",
      ...
      ["A ranking turns a continuous spread of quality into a few fixed steps",
      ...
      "The steps are few and the spread is continuous, so a hair's difference lands on one side of a line. Any classification draws lines through a distribution that has none, and the wines either side of a line are always more alike than the ranks make them look. That is where the value on a list usually sits, in the bottle just under the cut-off, sold at the price of its rank rather than at the price of its quality."),
