...
BANK = [
    ...
    Q("Hops, the kettle and the mash",
      ...
      ["Decoction mashing", "Step infusion mashing",
    ...
    Q("Hops, the kettle and the mash",
      ...
      ["The weight of the kettle charge, recalculated from the new assay",
       "The length of the boil, stretching it to extract the missing bitterness",
    ...
    Q("Fermentation and conditioning",
      ...
      ["It survives only through later German law binding domestic brewers; imports have been exempt since a 1987 European ruling",
    ...
    Q("Lambic and gueuze",
      ...
      ["Preservation, with bitterness and aroma deliberately faded away",
       "A bargain source of bittering, since drying concentrates the alpha acids",
    ...
    Q("Service policy",
      ...
      ["The cellar is right: cask bitter is meant for eleven to thirteen degrees",
      ...
      "Cellar temperature is the style's specification rather than a refrigeration failure: at eleven to thirteen degrees the low carbonation and the malt read as intended, while colder service mutes the beer and at lager temperature it tastes flat and empty. The guest-facing answer is a word of explanation and an offered alternative, not chilling a living beer into silence."),
    SA("Service policy",
