...
BANK = [
    ...
    Q("Vine biology and anatomy",
      ...
      ["Water storage", "Photosynthesis", "Nitrogen fixation", "Anchoring the vine"], 1,
    ...
    Q("Vine biology and anatomy",
      ...
      ["Cane", "Tendril", "Rachis", "Inflorescence"], 0,
    ...
    Q("The annual growth cycle",
      ...
      ["The vine flowers and the fertilised flowers set into berries",
       "Berries colour and begin to accumulate sugar",
       "The first leaves emerge from the buds after winter",
       "The vine sheds its leaves and rests until the spring"], 1,
    ...
    Q("The annual growth cycle",
      ...
      ["Ripening the last of its fruit", "Resting with no active growth",
       "Pushing new shoots out of its buds", "Producing a second crop from lateral shoots"], 1,
    ...
    Q("The annual growth cycle",
      ...
      ["It sets the potential crop size", "It marks the end of ripening",
    ...
    Q("Climate and weather",
      ...
      ["Warm dry summers and mild wet winters", "Cool wet summers and dry winters",
       "Uniform rainfall throughout the year", "Extreme day-to-night swings in the winter"], 0,
    ...
    Q("Climate and weather",
      ...
      ["It kills the vine's roots outright, so the vine must be replanted",
       "It kills the newly burst buds and shoots that carry the crop",
       "It freezes the sap in the trunk, splitting the wood permanently",
       "It causes grey rot in ripe fruit"], 1,
      "Frost after budbreak kills the tender buds and green shoots that would have borne fruit. Secondary buds may push but usually yield less and ripen later."),
    Q("Climate and weather",
    ...
    Q("Climate and weather",
      ...
      ["It has no measurable effect on the temperature of the fruit",
       "Slopes angled toward the sun receive more direct energy",
       "North-facing slopes always ripen fastest in the Northern Hemisphere",
       "Aspect only affects drainage, not the warmth of the site"], 1,
    ...
    Q("Soil and site",
      ...
      ["Chablis", "Chateauneuf-du-Pape", "Barossa Valley", "Willamette Valley"], 1,
    ...
    Q("Soil and site",
      ...
      ["A style of oak barrel traditionally used for maturing red wine",
       "The natural environment of a site and its mark on the wine",
       "A method of pruning that trains the vine along a wire",
       "A legally defined bottle shape reserved to one region"], 1,
    ...
    Q("Soil and site",
      ...
      ["They feed sugar directly into the ripening fruit",
       "They drain well yet hold reserve moisture",
    ...
    Q("Vineyard management",
      ...
      ["To increase the number of buds the vine carries into spring",
       "To balance sunlight and airflow around the fruit",
       "To raise the alcohol of the finished wine",
       "To stop the graft union failing in its first years"], 1,
    ...
    Q("Vineyard management",
      ...
      ["Cane pruning keeps long canes, spur pruning short spurs",
       "Cane pruning is done in summer and spur pruning in winter",
       "Cane pruning is used only on white varieties, spur pruning only on red",
       "There is no structural difference; the two words are interchangeable"], 0,
    ...
    Q("Vineyard management",
      ...
      ["Picking the whole crop before the grapes have coloured",
       "Dropping unripe bunches to concentrate the rest",
       "Harvesting at night so the fruit reaches the winery cool",
       "Planting a green cover crop between the rows"], 1,
    ...
    Q("Vineyard management",
      ...
      ["Biodynamics permits synthetic pesticides that organic rules forbid",
       "Biodynamics adds preparations and a lunar calendar",
       "Biodynamics forbids all ploughing and any work on the soil",
       "There is no difference; the two certifications cover the same rules"], 1,
    ...
    Q("Vineyard management",
      ...
      ["It is always faster than a machine over the same area",
       "Pickers can select, and whole bunches stay intact",
       "It removes any need to sort the fruit at the winery",
       "It is required by law for all red wine"], 1,
    ...
    Q("Vineyard management",
      ...
      ["water is unavailable", "it can inflate yields",
       "it damages rootstock", "it is impossible on slopes"], 1,
      "Withholding water keeps vines moderately stressed and berries small, and watering to push the crop up dilutes what is in the berries. Regions with reliable rainfall have tended to treat irrigation as a route to volume rather than quality."),
    Q("Vineyard management",
      "Higher vine planting density is generally intended to achieve what?",
      ["Larger berries and heavier bunches", "Competition between the vines",
       "Easier passage for machines between the rows", "A longer dormancy through the winter"], 1,
    ...
    Q("Hazards, pests and disease",
      ...
      ["A soil-borne fungus", "A root-feeding aphid", "A bacterium", "A virus"], 1,
    ...
    Q("Hazards, pests and disease",
      ...
      ["One fungus, benign in some conditions and spoiling in others",
       "Noble rot affects only red grapes, grey rot only whites",
       "Grey rot is a bacterium and noble rot is a fungus",
       "Noble rot only develops in the cellar after fermentation"], 0,
    ...
    Q("White winemaking",
      ...
      ["Filtering the wine through the spent skins", "Stirring the yeast sediment back into the wine",
    ...
    Q("White winemaking",
      ...
      ["strip every trace of colour out of the juice",
       "extract aroma compounds from the skins",
       "raise the acidity of the juice before pressing",
       "keep the juice from fermenting before it is pressed"], 1,
    ...
    Q("Red winemaking",
      ...
      ["The floating cap of skins", "The temperature of the cellar during ageing",
       "Sediment left in the finished bottle", "The dosage added to sparkling wine"], 0,
    ...
    Q("Red winemaking",
      ...
      ["Carbonic maceration", "Cold maceration", "Saignee", "Rack and return"], 0,
    ...
    Q("Red winemaking",
      ...
      ["bleeding off part of the juice early",
       "adding water to the must to bring the alcohol down",
       "blending press wine back into free-run wine",
       "fermenting the wine in sealed clay amphorae"], 0,
    ...
    Q("Red winemaking",
      ...
      ["restart a fermentation that has stuck", "shape and soften the tannins",
       "drive off volatile acidity picked up in fermentation",
       "settle the gross lees out before the wine is pressed"], 1,
    ...
    Q("Oak and maturation",
      ...
      ["More overt oak flavour and tannin", "Greater acidity and freshness", "Lower alcohol and softer tannin", "Nothing measurable"], 0,
    ...
    Q("Oak and maturation",
      ...
      ["It is always made of newer wood", "It has more surface area for its volume",
    ...
    Q("Oak and maturation",
      ...
      ["Charring the outside of the barrel to preserve it",
       "Heating the staves over fire during shaping",
       "Rinsing the barrel with hot water before filling",
       "Seasoning the staves outdoors before the barrel is built"], 1,
    ...
    Q("Sparkling production",
      ...
      ["Running the second fermentation in a sealed tank",
       "Ageing red wine on oak staves inside a steel tank",
       "Fortifying the wine with neutral grape spirit",
       "Freezing wine in the tank to concentrate it"], 0,
    ...
    Q("Sparkling production",
      ...
      ["Removing the plug of sediment from the neck",
       "Adding the yeast and sugar for the second fermentation",
    ...
    Q("Sparkling production",
      ...
      ["Before the first fermentation, to raise alcohol", "After disgorgement, setting the sweetness",
    ...
    Q("Sparkling production",
      ...
      ["Green apple and grass", "Bready, biscuity character", "Vanilla and coconut", "Coarse tannin"], 1,
      "Autolysis, the breakdown of the spent yeast cells, releases compounds giving brioche, biscuit and toast, and builds texture. Time on lees is the main lever for that character."),

    # ------------------------------------ fortified and sweet (6) ----------
    Q("Fortified and sweet production",
      "Port is fortified at which point?",
      ["After fermentation has finished completely", "Partway through fermentation",
       "Before fermentation begins, in the must", "At bottling, once ageing is finished"], 1,
    ...
    Q("Fortified and sweet production",
      "What is flor?",
      ["A film of yeast that grows on the surface of the wine", "A sweetening agent added to Sherry at bottling",
    ...
    Q("Fortified and sweet production",
      ...
      ["drying the grapes before fermentation",
       "fortifying the must partway through fermentation",
       "fermenting the wine under a veil of flor yeast",
    ...
    Q("Fortified and sweet production",
      ...
      ["It adds sugar of its own into the pulp of the berry",
       "It punctures the skin so water evaporates",
       "It converts the berry's acid into extra sugar",
       "It prevents fermentation entirely"], 1,
    ...
    Q("Faults and stabilisation",
      ...
      ["TCA (2,4,6-trichloroanisole)", "Acetaldehyde (ethanal)", "Ethyl acetate (ethyl ethanoate)", "Sulphur dioxide (SO2)"], 0,
    ...
    Q("Faults and stabilisation",
      ...
      ["To sweeten the wine just before bottling", "To act as antioxidant and antimicrobial",
       "To deepen the colour of a red wine in barrel", "To convert malic acid into softer lactic acid"], 1,
    ...
    Q("Faults and stabilisation",
      ...
      ["Fining agents settle particles; filtration strains them",
       "They are the same process under two different names",
       "Fining is used only on red wine, filtration only on white",
       "Filtration always takes place before fermentation"], 0,
