...
BANK = [
    ...
    Q("Sonoma County",
      ...
      ["Green Valley of Russian River Valley", "Chalk Hill", "Bennett Valley",
       "Fountaingrove District"], 0,
    ...
    Q("Santa Cruz Mountains and Monterey",
      ...
      ["A deep submarine canyon reaching almost to the shoreline",
       "A chain of offshore islands", "A warm counter-current running north",
       "A shallow sandbar across the bay mouth"], 0,
      "The canyon is one of the deepest on the continental margin and brings cold water from far below the surface within reach of the shore. The Salinas Valley opens straight onto it, so the afternoon wind is strong enough that row orientation and trellis height are planned around it rather than around sunlight."),
    ...
    Q("Paso Robles and San Luis Obispo",
      ...
      ["The west side, on calcareous shale reached by marine air",
       "The east side, on deep alluvial soils away from the fog",
    ...
    Q("Santa Barbara County",
      ...
      ["A Chilean estate already trading as Santa Rita",
       "A Spanish denomination of the same name",
       "A Portuguese quinta of the same name",
       "An Argentine bodega of the same name"], 0,
      "The abbreviation is a legal settlement rather than a stylistic quirk, which is why it is always written that way and never spelled out in full. The appellation itself occupies the cold, wind-scoured western end of its valley, where the transverse ranges let the ocean straight in."),
    Q("Santa Barbara County",
    ...
    Q("Sierra Foothills and Lodi",
      ...
      ["Nothing at all, since the phrase has no legal definition",
