...
BANK = [
    ...
    Q("Scales of climate",
      ...
      ["Microclimate", "Mesoclimate", "Macroclimate", "Growing season climate"], 0,
    ...
    Q("Scales of climate",
      ...
      ["Removing leaves from the fruiting zone",
       "Planting the next block a hundred metres higher up the slope",
    ...
    Q("Climate models and the metrics that separate them",
      ...
      ["Continentality", "Diurnal range", "Heat summation", "Growing season temperature"], 0,
    ...
    Q("Climate models and the metrics that separate them",
      ...
      ["Respiration of malic acid inside the berry", "Photosynthesis in the leaf",
    ...
    Q("Slope, aspect, elevation and cold-air drainage",
      ...
      ["The sun sits lower in the sky at high latitude, so sloped ground meets its rays closer to perpendicular",
      ...
      "Energy per square metre depends on the angle at which light strikes the ground. Near the equator the sun is close to overhead and a slope gains almost nothing, which is why aspect is an obsession on the Mosel and an irrelevance in Mendoza, where elevation does the work instead."),
    Q("Slope, aspect, elevation and cold-air drainage",
      ...
      ["Fine material has washed downhill, leaving the slope thin and free-draining and the flat deep and fertile",
       "Rainfall totals are higher on slopes than on valley floors",
       "Slopes accumulate deeper topsoil than the ground below them",
       "Slopes hold more organic matter, which feeds the vine steadily"], 0,
    ...
    Q("Slope, aspect, elevation and cold-air drainage",
      ...
      ["A very wide swing between day and night temperatures", "A short growing season",
    ...
    Q("Water, fog and rain shadow",
      ...
      ["A shorter, cooler effective day, which slows sugar accumulation while acid holds",
      ...
      "The fog caps the temperature and cuts the hours of full sun, stretching ripening out so that flavour and tannin can catch up with sugar. It is a cooling mechanism that works in a region with no rain at all in summer, which is why the coldest sites in California can sit at the latitude of North Africa."),
    ...
    Q("Frost, hail and vintage extremes",
      ...
      ["Melting and evaporation then pull heat out of the bud instead of releasing it",
       "The ice sheet cracks and severs the shoot", "The added water dilutes the sap in the bud",
       "Wet buds attract downy mildew before dawn"], 0,
      "Protection comes from the latent heat given up as water freezes, which holds the bud at about zero as long as fresh water keeps arriving and keeps freezing. Cut the supply and the phase change runs the other way, absorbing heat from the bud it was protecting and driving it below the temperature it would have reached unprotected."),
    Q("Frost, hail and vintage extremes",
      ...
      ["Stomata close and photosynthesis all but stops above the mid-thirties",
       "The vine flowers for a second time",
       "Malic acid is synthesised faster than it is respired",
       "Root growth accelerates in search of water"], 0,
      "Closing the stomata is the vine's defence against losing water it cannot replace, and it shuts down carbon dioxide uptake at the same time. Sugar accumulation therefore pauses while acid continues to be burnt off, which is how a heatwave manages to deliver unripe flavours and flabby wines together."),
    ...
    Q("Limestone, chalk and marl",
      ...
      ["Very high porosity, with fissures that let free water drain away",
    ...
    Q("Clay, gravel, sand and loess",
      ...
      ["They drain fast and warm quickly, which suits a late-ripening variety",
       "They are unusually rich in potassium",
       "They hold water far into a dry summer",
       "They are the only soils in which phylloxera cannot survive"], 0,
    ...
    Q("Clay, gravel, sand and loess",
      ...
      ["It holds water and warms slowly, so the root zone stays cold well into spring",
       "It reflects light back into the canopy", "It raises soil pH sharply",
       "It confines roots to the top twenty centimetres"], 0,
      "Water has a high heat capacity, so a wet soil takes far longer to warm than a dry stony one and the whole cycle from budbreak onward is pushed back. The same water reserve is what fills the berry and gives the wine its flesh, so the delay and the texture arrive together."),
    Q("Clay, gravel, sand and loess",
      ...
      ["Deep pure sand, through which the louse cannot move",
    ...
    Q("Schist, granite and volcanic ground",
      ...
      ["Rain drains away through the fissures, and roots follow them down to water",
       "It supplies nitrogen to the vine",
       "It reflects ultraviolet light away from the fruit",
    ...
    Q("Schist, granite and volcanic ground",
      ...
      ["Restrained vigour and small berries, because water and nutrient are both scarce",
       "High vigour and large berries", "A pronounced delay in budbreak",
       "Chlorosis brought on by excess active lime"], 0,
    ...
    Q("Schist, granite and volcanic ground",
      ...
      ["They are deep, porous and free-draining while still holding useful water",
       "They are unusually rich in nitrogen", "They are strongly alkaline",
       "They suppress fungal disease in the canopy"], 0,
      "Ash and pumice weather into a light, open profile that takes water in fast and gives it back slowly, which is a rare combination. Young volcanic soils are typically poor in nitrogen rather than rich, and the flavour claims made for them are far harder to demonstrate than the drainage is."),
    ...
    Q("Drainage, water stress and vigour",
      ...
      ["Expansion stops early, and the vine's resources go into skin compounds rather than pulp",
    ...
    Q("Drainage, water stress and vigour",
      ...
      ["Field capacity and the permanent wilting point", "Bulk density and porosity",
       "pH and cation exchange capacity", "Albedo and infiltration rate"], 0,
    ...
    Q("What terroir explains and what it does not",
      ...
      ["Soil acts on wine chiefly through water supply and vine vigour, not by transferring flavour",
