...
BANK = [
    ...
    Q("Anjou, the Layon and the sweet appellations",
      ...
      ["A lower maximum yield and a higher minimum ripeness than the plain appellation",
      ...
      "Six communes of the Layon may append their names, and the concession is paid for with a smaller crop and riper fruit. The addition sits above plain Coteaux du Layon and below the named crus of the valley, so it is a rung on a ladder rather than a decoration."),
    Q("Anjou, the Layon and the sweet appellations",
      ...
      ["Hills standing between the valley and the ocean, which take the rain out of the westerly air",
    ...
    Q("Savennieres and its crus",
      ...
      ["The appellation permits demi-sec and moelleux, and off-dry Savennieres was once the norm",
      ...
      "Bone-dry Savennieres is a modern preference rather than a rule, and the decree still allows the sweeter categories. The slope can do either, because the schist ripens Chenin hard while the river brings the autumn mists, so the decision is made in the vineyard rather than in the rulebook."),
    ...
    Q("Sancerre, Pouilly and the soils of the Centre",
      ...
      ["Pouilly-Fume is white only, while Sancerre covers all three colours",
       "Pouilly-Fume's red is made in exceptional vintages alone and is rarely exported",
