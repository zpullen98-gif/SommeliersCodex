...
BANK = [
    ...
    Q("Wood ageing and the lodges of Gaia",
      ...
      ["The valley cask has aged faster and given back far less wine, because the Douro summer is much hotter",
    ...
    Q("Madeira: the heat and the rules",
      ...
      ["The roof space is the hottest part of the building, so the youngest wine takes the strongest heat and then matures more gently as it descends",
      ...
      "Warmth is the engine of everything the island's wine does, so where a cask sits in the building is a decision about how fast it will develop. A lot may spend twenty years working its way down to the ground floor, and the lodge's own summer does all of it."),
    Q("Madeira: the heat and the rules",
