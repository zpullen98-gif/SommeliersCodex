...
BANK = [
    ...
    Q("The methods at depth",
      ...
      ["On bottling day, in how much unfermented sugar is still in the wine as it goes under the cap",
       ...
       "In the cellar's temperature, cold storage setting how much carbon dioxide the finished wine holds"], 0,
    ...
    Q("The Americans and their French parents",
      ...
      ["A grandfather clause: labels approved before the 2006 accord with Europe keep semi-generic names beside their origin",
