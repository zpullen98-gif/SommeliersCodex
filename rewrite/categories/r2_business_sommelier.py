...
BANK = [
    ...
    Q("Cost percentage against cash margin",
      ...
      ["It banked 120 against the other bottle's 60, and profit is deposited as cash rather than as a percentage",
       "Its higher selling price lifts the night's average check, and average check is the number head office watches",
    ...
    Q("Markup architecture and the price of a pour",
      ...
      ["It carries the whole risk of the open bottle, and the guest is spared committing to a full one",
    ...
    Q("Engineering the list",
      ...
      ["How often it sells, and how much cash each sale leaves behind",
       "Its beverage cost percentage, and its supplier's discount tier",
    ...
    Q("The glass programme and preservation economics",
      ...
      ["About 280 of wine a week stops going down the sink, and 3,000 is eleven weeks of that",
      ...
      "Two bottles at 20 is 40 a night and 280 a week, poured away. Against that, 3,000 of kit is under eleven weeks of losses, so the system pays for itself inside three months and everything after that is margin. Preservation is bought with wine that was already being thrown out."),
    Q("The glass programme and preservation economics",
