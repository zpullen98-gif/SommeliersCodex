...
BANK = [
    ...
    Q("Climat, lieu-dit and reading the map",
      ...
      ["A vineyard that was, or still is, enclosed by a wall",
    ...
    Q("Chablis and the Grand Auxerrois",
      ...
      ["Whether one soil formation alone should qualify, or whether slope and exposure could also admit land",
       "Whether machine harvesting should be permitted below premier cru",
    ...
    Q("Chalonnaise, Hautes-Cotes and Maconnais",
      ...
      ["Later ripening, higher acidity and lighter body",
       "Higher alcohol and markedly lower acidity",
       "Deeper colour and firmer tannin", "Sweetness from regular botrytis"], 0,
      "The Hautes-Cotes de Nuits and Hautes-Cotes de Beaune sit a couple of hundred metres higher, so budbreak and harvest both run late and the fruit arrives leaner. Warm vintages have done more for them than for anywhere else in Burgundy, which is why they now appear on lists that ignored them for a generation."),
    Q("Chalonnaise, Hautes-Cotes and Maconnais",
    ...
    Q("Beaujolais and its crus",
      ...
      ["Juice pressed out under the weight of the fruit ferments at the base and fills the vat with it",
    ...
    Q("Grapes beyond the two",
      ...
      ["Thirty percent", "Ten percent", "Fifty percent", "Eighty percent"], 0,
      "At least thirty percent Pinot Noir and at least fifteen percent Gamay, and the two must go into the vat together rather than be blended afterwards. The name records the old peasant practice of throwing every grape on the holding into one fermenter, which is exactly what the co-fermentation rule preserves."),
    ...
    Q("Domaine, negociant and metayage",
      ...
      ["The first was bottled by the grower of the fruit; the second may have been bottled by a merchant who bought it",
       "The first was bottled in Burgundy, the second outside France",
