...
BANK = [
    ...
    Q("The GI machine and the Coonawarra line",
      ...
      ["Homogeneity in grape growing, at least five independent vineyards of five hectares each, and five hundred tonnes of grapes a year",
      ...
      "The regulations ask for a single tract of land, discrete from its neighbours and homogeneous in its growing attributes, with the five-vineyard, five-hectare and five-hundred-tonne figures as the floor of scale: five separately owned vineyards, each of at least five hectares, and in the order of five hundred tonnes of grapes produced in a year. Style and soil are deliberately absent from the test, which is the system in miniature: the law measures where, never how or what."),
    ...
    Q("Barossa floor, Eden altitude and the Old Vine Charter",
      ...
      ["A charter the growers wrote themselves, its tiers binding nobody but the producers who sign it",
       "Federal labelling law, which sets a national minimum age and audits the claim through vineyard records",
    ...
    Q("Hunter Semillon and the Riesling valleys",
      ...
      ["Ferocious acid, alcohol near eleven percent, and the crop in before the February rains break",
       "The green capsicum edge the style is built on, which another fortnight of sun would burn away",
    ...
    Q("Hunter Semillon and the Riesling valleys",
      ...
      ["The screwcapped wine paler and limier, the corked one deeper, broader and scattered bottle to bottle",
       ...
       "The screwcapped bottle the deeper gold of the pair, metal conducting heat into the wine faster than cork can"], 0,
    ...
    Q("Rutherglen, the river and the show bench",
      ...
      ["The water market: allocations trade separately from land, and that year's price beat the crop",
       "Seniority: licences issued earliest draw first in a shortage, and the newest vineyards queue behind the orchards",
    ...
    Q("Rutherglen, the river and the show bench",
      ...
      ["Against a fixed score line: every wine that clears the mark takes a medal, whatever its class does",
      ...
      "The capital-city shows judge each class against a score standard, so a medal goes to every wine over the line no matter how many that leaves, and the trophies above them are judged competitively among the golds. Medal stickers move stock off retail shelves, which is why companies enter at industrial scale and why show results have steered Australian style for a century."),
    SA("Rutherglen, the river and the show bench",
