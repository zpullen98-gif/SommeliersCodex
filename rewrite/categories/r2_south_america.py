...
BANK = [
    ...
    Q("Chile: Carmenere and ungrafted vines",
      ...
      ["Nematodes in old soils, and rootstocks bred for drought",
       "European buyers who insist on grafted vineyards before listing a wine",
    ...
    Q("Argentina: elevation as the variable",
      ...
      ["Firmer acidity, floral lift and a tauter, less fleshy build",
       "Deeper colour and softer, riper tannin",
       "Higher alcohol from the stronger sunlight",
       "An earlier harvest by roughly a month"], 0,
      "Every hundred metres climbed cools the site the way a move poleward would, so the high Uco picks later, holds more natural acid and trades Lujan's plush mid-palate for tension. Sunlight does intensify with altitude, but it thickens skins rather than pushing alcohol up."),
    ...
    Q("Uruguay: Tannat on an Atlantic coast",
      ...
      ["Farming irrigated desert in the shelter of a rain shadow",
    ...
    Q("Brazil: Serra Gaucha and its sparkling wines",
      ...
      ["Moscatel grapes, their sparkle raised in a closed tank",
      ...
      "Farroupilha holds a geographical indication specifically for its Moscatels, and tank fermentation preserves the grape's fresh perfume the way it does in Asti. The Serra's traditional-method houses work mostly with Chardonnay and Pinot Noir, so the two styles split the market between them."),
    SA("Brazil: Serra Gaucha and its sparkling wines",
